...
\paragraph*{2. Isovolumisk kontraktion}
...
\begin{figure}[H] % Example of including images
\begin{center}
\includegraphics[width=1\textwidth]{figures/cyklus.png}
\end{center} 
